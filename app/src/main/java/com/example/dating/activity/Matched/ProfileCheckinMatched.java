...
import com.example.dating.Utils.CalculateAge;
...
public class ProfileCheckinMatched extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: user name is" + user.getName());
        ...
        CalculateAge cal = new CalculateAge(user.getBirth());
        int age = cal.getAge();

        profile_name.setText(user.getName() + ", " + age + " tuổi");
...
//        }
        ...
        profile_interest.setText(user.getInterests());

        String profileImageUrl = user.getAvatar();
...
//            @Override
//            public void onClick(View v) {
//                sendSMS(user.getPhone_number(), user.getName());
//            }
//        });
