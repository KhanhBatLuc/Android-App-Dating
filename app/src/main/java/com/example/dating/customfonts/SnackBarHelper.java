...
public class SnackBarHelper {
    ...
    private static void setTypeFace(Context context, Snackbar snackbar) {
        ...
        Typeface font = Typeface.createFromAsset(context.getAssets(), "font/dana_regular.ttf");
        Typeface bold = Typeface.createFromAsset(context.getAssets(), "font/dana_bold.ttf");
        tv.setTypeface(font);
