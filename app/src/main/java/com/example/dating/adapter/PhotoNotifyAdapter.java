...
public class PhotoNotifyAdapter extends ArrayAdapter<User> {
    Context mContext;


    public PhotoNotifyAdapter(@NonNull Context context, int resource, @NonNull List<User> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext.getApplicationContext()).inflate(R.layout.item_notify, parent, false);
        }
...
//        CardView cardView = convertView.findViewById(R.id.cardView);
        ...
        Log.e("PhotoNotifyAdapter user", AppConfig.IMAGE_URL + user.getAvatar());
